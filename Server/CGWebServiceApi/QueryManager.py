...
SELECT_USER_CREDIT_CARD = """SELECT card_exp_date AS cexpdate, payment_methodid AS cid, card_number AS cnumber, card_type AS ctype
                              FROM payment_method
                              WHERE userid = {0}"""
...
UPDATE_USER_ACCOUNT = """UPDATE account_info
                          ...
                          WHERE accountid = (SELECT accountid FROM cg_user WHERE userid = {2})"""



UPDATE_USER_CART = """UPDATE cart_contains AS cc
                      SET cart_product_qty = {0}
                      WHERE productid = {1} AND cc.cartid IN (SELECT cartid FROM cart WHERE userid = {2} AND cart.active = TRUE )"""



UPDATE_USER_PAYMENT_METHOD = """UPDATE payment_method
                                SET active = FALSE
...
INSERT_PRODUCT_INTO_CART = """INSERT INTO cart (userid, active, insert_date) values ({0},TRUE ,current_date)"""
